...
#code that will count how many times ppmReader.get_values() can be run in one second and post it here
# start_time = utime.ticks_ms()
# count = 0

# while utime.ticks_diff(utime.ticks_ms(), start_time) < 1000:  # Run for 1000 milliseconds (1 second)
#     ppmReader.get_values()
#     count += 1

# print("Function ran", count, "times in one second.")